...
$(function(){
  $("#pieChart").drawPieChart([
    ...
    { title: "necessities",        value : 17,   color: "salmon" },
    // { title: "necessities",        value : 10,   color: "salmon" },
    { title: "savings",      value:  20,   color: "lightpink" },
    { title: "other",        value : 20,   color: "#EB0D42" }
  ...
  $.fn.drawPieChart = function(data, options) {
    var $this = this,
      ...
      settings = $.extend({
        ...
        lightPiesOffset: 15,//lighten pie's width
    ...
    function pathMouseEnter(e){
      ...
      $tip.text(data[index].title + ": $" + data[index].value*monthlyIncome/100 + " (" + data[index].value + "%)").fadeIn(200);
